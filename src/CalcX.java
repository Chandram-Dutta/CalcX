...
public class CalcX implements ActionListener{
    ...
    CalcX(){
        ...
        titleIcon = new ImageIcon("Icons/Calc X Logo(48).png");
        titleButtonIcon = new ImageIcon("Icons/title3bars.png");
...
//        aboutAppMenuItem.setBorder(BorderFactory.createLineBorder(Color.black,2));
        aboutAppMenuItem.addActionListener(e -> aboutFrame.setVisible(true));
        ...
        themeMenuItem.addActionListener(e -> themeFrame.setVisible(true));
...
//		creditLabel.setBorder(BorderFactory.createLineBorder(Color.red,1));
        ...
        aboutLogoLabel = new JLabel(new ImageIcon("Icons/Calc X Logo(200).png"));
        ...
        String s = "<html><p style = \"font-family:SF  UI;font-size:9px;font-style:bold;\">"
                ...
                + "DAEDALUS SOFTWARE © 2021<br>Version - 1.0(Stable)(Windows)";
...
//		delButton.setIcon((new ImageIcon("/home/chandramdutta/CalcX/Icons/del.png")));
        ...
        mainFrame.setTitle("CALC X - V.1.0(DSC INC. © 2021-22)");
//		mainFrame.getContentPane().setBackground(Color.black);
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if ((s.charAt(0) >= '0' && s.charAt(0) <= '9') || s.charAt(0) == '.') {
            ...
            StringBuilder tempString= new StringBuilder(s0 + s1 + s2);
